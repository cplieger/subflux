...
var ignoredCodecTable = []struct {
	enabled func(subflux.EmbeddedPolicy) bool
	codecs  []string
}{
	{func(p subflux.EmbeddedPolicy) bool { return p.IgnorePGS }, []string{"pgs"}},
	{func(p subflux.EmbeddedPolicy) bool { return p.IgnoreVobSub }, []string{"vobsub"}},
	{func(p subflux.EmbeddedPolicy) bool { return p.IgnoreASS }, []string{"ass", "ssa"}},
}
