// errors.go contains typed HTTP error response helpers.
...
// Core response infrastructure lives in response.go.
...
// Every helper accepts *http.Request so the request id flows into the response
// envelope automatically. Pass an empty string for code when no machine-readable
// code applies; the envelope then carries only `error`, since `code` is
// omitempty.

// BadRequestC writes a 400 with the given code and message.
func BadRequestC(w http.ResponseWriter, r *http.Request, code api.ErrorCode, msg string) {
	writeError(w, r, http.StatusBadRequest, code, msg)
}

// UnauthorizedC writes a 401 with the given code and message.
func UnauthorizedC(w http.ResponseWriter, r *http.Request, code api.ErrorCode, msg string) {
	writeError(w, r, http.StatusUnauthorized, code, msg)
}

// ForbiddenC writes a 403 with the given code and message.
func ForbiddenC(w http.ResponseWriter, r *http.Request, code api.ErrorCode, msg string) {
	writeError(w, r, http.StatusForbidden, code, msg)
}

// NotFoundC writes a 404 with the given code and message.
func NotFoundC(w http.ResponseWriter, r *http.Request, code api.ErrorCode, msg string) {
	writeError(w, r, http.StatusNotFound, code, msg)
}

// MethodNotAllowedC writes a 405 with the given code.
func MethodNotAllowedC(w http.ResponseWriter, r *http.Request, code api.ErrorCode) {
	writeError(w, r, http.StatusMethodNotAllowed, code, "method not allowed")
}

// ConflictC writes a 409 with the given code and message.
func ConflictC(w http.ResponseWriter, r *http.Request, code api.ErrorCode, msg string) {
	writeError(w, r, http.StatusConflict, code, msg)
}

// PayloadTooLargeC writes a 413 with the given code and message.
func PayloadTooLargeC(w http.ResponseWriter, r *http.Request, code api.ErrorCode, msg string) {
...
func TooManyRequestsC(w http.ResponseWriter, r *http.Request, code api.ErrorCode, msg string) {
	writeError(w, r, http.StatusTooManyRequests, code, msg)
}

// BadGatewayC writes a 502 with the given code and message.
func BadGatewayC(w http.ResponseWriter, r *http.Request, code api.ErrorCode, msg string) {
	writeError(w, r, http.StatusBadGateway, code, msg)
}

// ServiceUnavailableC writes a 503 with the given code and message.
func ServiceUnavailableC(w http.ResponseWriter, r *http.Request, code api.ErrorCode, msg string) {
...
func InternalErrorC(w http.ResponseWriter, r *http.Request, err error, code api.ErrorCode, logAttrs ...any) {
	if err != nil {
