...
func TooManyRequestsC(w http.ResponseWriter, r *http.Request, code subflux.ErrorCode, msg string) {
	writeError(w, r, http.StatusTooManyRequests, code, msg)
}

// BadGatewayC writes a 502 with the given code and message.
func BadGatewayC(w http.ResponseWriter, r *http.Request, code subflux.ErrorCode, msg string) {
	writeError(w, r, http.StatusBadGateway, code, msg)
}

// ServiceUnavailableC writes a 503 with the given code and message.
func ServiceUnavailableC(w http.ResponseWriter, r *http.Request, code subflux.ErrorCode, msg string) {
