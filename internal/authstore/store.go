...
// standalone github.com/cplieger/auth/v3 library so subflux call sites can
...
import authlibstore "github.com/cplieger/auth/v3/store"
...
//
// This is a type alias of github.com/cplieger/auth/v3/store.Composite — the
