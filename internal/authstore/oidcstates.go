...
// restart by design; an in-flight OIDC login simply retries.
//
...
//     CSRF/replay protection; doing the read+delete under a
...
// by the background sweeper), mirroring the absolute-timeout
...
// SQLite store's ErrOIDCStateNotFound observable behaviour.
...
// errOIDCStateNotFound (anti-replay).
...
// exactly at the cutoff is kept rather than evicted.
