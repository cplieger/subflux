...
// RequireAuth checks authentication and returns the user.
...
func CanDisableAuthMethod(method api.AuthMethod, hasPassword bool, passkeyCount int, oidcEnabled, oidcLinked bool) bool {
	return authlib.CanDisableAuthMethod(authlib.Method(method), hasPassword, passkeyCount, oidcEnabled, oidcLinked)
}
